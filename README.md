# ByRamona Belleza Integral
Este es un proyecto de ecommerce básico que se utiliza para el curso de React. La aplicación permite ver una lista de productos de belleza capilar, facial y corporal y realizar compras en línea. Los productos y las órdenes de compra se almacenan en Firebase.
...
5. Abre tu navegador y navega a http://localhost:3001 (el puerto esta seteado en el archivo de configuracion) para ver la aplicación en acción.
